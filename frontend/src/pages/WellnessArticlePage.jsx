...
import { getWellnessArticle, wellnessArticles } from '../data/wellnessArticles.js'

export default function WellnessArticlePage() {
  const { slug } = useParams()
  const article = getWellnessArticle(slug)
    ...
    return (
      <section className="grid min-h-[620px] place-items-center bg-[#f6f5ee] px-4 py-24 text-center">
        <div className="max-w-lg">
          ...
          <p className="mt-6 text-[10px] font-black uppercase tracking-[.2em] text-[#a1721c]">Wellness centre</p>
          <h1 className="mt-3 font-display text-5xl text-[#183724]">This article is not available.</h1>
          <p className="mt-4 text-sm leading-7 text-[#6d7a71]">The link may have changed. Browse the complete wellness library to continue reading.</p>
          <Link to="/wellness" className="mt-7 inline-flex items-center gap-2 rounded-full bg-[#123b2a] px-6 py-3 text-[9px] font-black uppercase tracking-wider text-white">
  ...
  return (
    <div className="bg-[#f6f5ee]">
      <header className="relative overflow-hidden bg-[#08271b] px-4 pb-16 pt-10 text-white sm:px-6 sm:pb-20 lg:px-8">
        <img src="/images/botanical-hero-bg.png" alt="" className="absolute inset-0 h-full w-full object-cover opacity-[.1]" />
        ...
        <div className="relative mx-auto max-w-7xl">
          <nav className="flex flex-wrap items-center gap-1.5 text-[8px] font-black uppercase tracking-[.13em] text-white/45" aria-label="Breadcrumb">
            <Link to="/wellness" className="transition hover:text-[#e2bc62]">Wellness centre</Link>
          ...
          <div className="mt-8 grid items-center gap-9 lg:grid-cols-[1fr_480px] lg:gap-14">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[.22em] text-[#e1b85d]">Evidence-aware wellness guide</p>
              ...
              <div className="mt-7 flex flex-wrap gap-3 text-[9px] font-bold uppercase tracking-wider text-white/65">
                ...
                <span className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/[.06] px-4 py-2.5"><CalendarDays className="h-3.5 w-3.5 text-[#e2bb61]" /> Checked {article.updated}</span>
              </div>
            </div>
      ...
      <main className="mx-auto grid max-w-7xl items-start gap-7 px-4 py-12 sm:px-6 lg:grid-cols-[minmax(0,1fr)_310px] lg:px-8 lg:py-16">
        <article className="min-w-0 rounded-[2rem] border border-[#dfe4dc] bg-white px-5 py-7 shadow-[0_18px_50px_rgba(26,53,35,.06)] sm:px-9 sm:py-10 lg:px-12">
          ...
          <section className="mt-9 rounded-[1.5rem] border border-[#d7e2d3] bg-[#eef5eb] p-5 sm:p-6" aria-labelledby="at-a-glance">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[8px] font-black uppercase tracking-[.16em] text-[#8d671f]">Key ideas</p>
                <h2 id="at-a-glance" className="mt-0.5 font-display text-2xl text-[#193725]">At a glance</h2>
              </div>
            </div>
            ...
            {article.sections.map((section, index) => (
              <section key={section.id} id={section.id} className="scroll-mt-28">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[8px] font-black uppercase tracking-[.16em] text-[#a1721c]">Article section</p>
          ...
          <section className="mt-12 overflow-hidden rounded-[1.6rem] bg-[#0e3022] p-6 text-white sm:p-8" aria-labelledby="action-plan">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[8px] font-black uppercase tracking-[.16em] text-[#dfb75e]">Put it into practice</p>
          ...
          <section className="mt-7 rounded-[1.5rem] border border-[#ead2aa] bg-[#fff8e8] p-5 sm:p-6" aria-labelledby="safety-note">
            <div className="flex gap-4">
              ...
              <div>
                <h2 id="safety-note" className="font-display text-2xl text-[#473719]">When individual advice matters</h2>
          ...
          <section id="sources" className="mt-11 scroll-mt-28 border-t border-[#e3e7e0] pt-8" aria-labelledby="sources-title">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[8px] font-black uppercase tracking-[.16em] text-[#a1721c]">Further reading</p>
                <h2 id="sources-title" className="mt-1 font-display text-3xl text-[#193725]">Sources and guidance</h2>
              </div>
            </div>
        ...
        <aside className="space-y-5 lg:sticky lg:top-24">
          <nav className="rounded-[1.5rem] border border-[#dde3da] bg-white p-5" aria-label="Article contents">
            <div className="flex items-center gap-2"><BookOpen className="h-4 w-4 text-[#a1721c]" /><h2 className="text-[9px] font-black uppercase tracking-[.15em] text-[#344b3b]">On this page</h2></div>
            <div className="mt-4 grid gap-1.5">
              <a href="#at-a-glance" className="rounded-lg px-3 py-2 text-[11px] font-semibold text-[#65746b] transition hover:bg-[#f1f5ee] hover:text-[#1e4a30]">At a glance</a>
              ...
              <a href="#sources" className="rounded-lg px-3 py-2 text-[11px] font-semibold text-[#65746b] transition hover:bg-[#f1f5ee] hover:text-[#1e4a30]">Sources and guidance</a>
            </div>
          </nav>

          <div className="rounded-[1.5rem] border border-[#d8e0d5] bg-[#edf4ea] p-5">
            <p className="text-[8px] font-black uppercase tracking-[.15em] text-[#8f681f]">Editorial note</p>
            <p className="mt-3 text-xs leading-6 text-[#586a5e]">This article was checked against the authoritative sources listed on this page in {article.updated}. It provides general education, not personal medical advice.</p>
          </div>

          <Link to="/wellness" className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#123b2a] px-5 py-3.5 text-[9px] font-black uppercase tracking-wider text-white transition hover:bg-[#0b2c1e]">
            <ArrowLeft className="h-4 w-4" /> All wellness articles
          </Link>
        </aside>
      </main>
      ...
      <section className="border-t border-[#dfe4dc] bg-[#eef1e9] px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
            <div><p className="text-[9px] font-black uppercase tracking-[.18em] text-[#a1721c]">Continue learning</p><h2 className="mt-2 font-display text-4xl text-[#193725]">Related wellness guides</h2></div>
            <Link to="/wellness" className="inline-flex items-center gap-2 text-[9px] font-black uppercase tracking-wider text-[#90651b]">View all articles <ArrowUpRight className="h-4 w-4" /></Link>
          </div>
          <div className="mt-7 grid gap-5 md:grid-cols-3">
            {relatedArticles.map((related) => (
              <Link key={related.slug} to={`/wellness/${related.slug}`} className="group overflow-hidden rounded-[1.5rem] border border-[#d8dfd5] bg-white transition hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(30,59,39,.1)]">
                ...
                <div className="p-5"><p className="text-[8px] font-black uppercase tracking-[.13em] text-[#9b6c1a]">{related.category} · {related.read}</p><h3 className="mt-2 font-display text-2xl leading-tight text-[#193725]">{related.title}</h3><span className="mt-4 inline-flex items-center gap-2 text-[8px] font-black uppercase tracking-wider text-[#8e6319]">Read guide <ArrowUpRight className="h-3.5 w-3.5 transition group-hover:translate-x-1 group-hover:-translate-y-1" /></span></div>
              </Link>
            ))}
          </div>
        </div>
